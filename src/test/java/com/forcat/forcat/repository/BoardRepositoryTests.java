...
public class BoardRepositoryTests {
    ...
    public void testRegister () {
        ...
        BoardDTO boardDTO = BoardDTO.builder ()//BoardDTO 객체 생성 및 초기화, 정보를 담는다.
                .title ("Sample Title...").content ("Sample Content...").writer ("user00").build ();
    ...
    public void testModify () {
        //변경에 필요한 데이터만 입력
        BoardDTO boardDTO = BoardDTO.builder ().bno (100L).title ("Updated Title...100").content ("Updated Content...100").build ();
    ...
    public void testList () {
        ...
        PageRequestDTO pageRequestDTO = PageRequestDTO.builder ().type ("tcw")//검색 조건
                .keyword ("1")//검색 키워드
                .page (1)//현재 페이지 번호
                .size (10)//페이지 크기
                .build ();
