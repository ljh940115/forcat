...
public class ContentController {
    ...
    @GetMapping("/contentRecentList")
    public void contentRecentList(ContentPageRequestDTO contentPageRequestDTO, Model model) {

        /*ContentPageResponseDTO<ContentListAllDTO> contentRecentResponseDTO = contentService.searchWithContentRecent(contentPageRequestDTO);*/
       /* log.info(contentRecentResponseDTO);
        model.addAttribute("contentRecentResponseDTO", contentRecentResponseDTO);*/
