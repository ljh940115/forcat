...
public interface BoardService {
    ...
    void remove (Long bno);//게시글 삭제

    PageResponseDTO<BoardDTO> list (PageRequestDTO pageRequestDTO);//페이지 목록 검색

    PageResponseDTO<BoardListReplyCountDTO> listWithReplyCount (PageRequestDTO pageRequestDTO);//댓글의 숫자까지 처리

    PageResponseDTO<BoardListAllDTO> listWithAll (PageRequestDTO pageRequestDTO);//게시글의 이미지와 댓글의 숫자까지 처리
